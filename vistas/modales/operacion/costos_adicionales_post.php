		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					Agregar costos adicionales al posteriores al viaje
				</h4>
			</div>
							...
							<script>
								jQuery(function($) {
									$('#costosAdicionales').dataTable( {
										...
										"ajax": {
											"url": "operacion/costos_adicionales_get_post/" + <?=$id_viaje?>,
											"type": "POST"
										}
									} );
								});
				...
				#costos_adicionales > div.modal-footer{
					...
					<form role="form" id="costos_adicionales">
						...
						<div class="modal-footer">
							...
							<button  class="btn btn-ar btn-success" type="button" onclick="costos_adicionales_do_post();">Capturar</button>
