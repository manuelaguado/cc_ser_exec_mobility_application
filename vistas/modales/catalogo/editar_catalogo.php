							...
							<div class="row">
								<div class="col-md-12">
									  ...
									  <div class="form-group">
											...
											<div class="checkbox">
												<input id="chk_activo" name="chk_activo" type="checkbox" <?php echo $chk_activo; ?> style="position:relative; left:20px;" onchange="func_chk_activo('<?=$activo?>')">
											</div>
									  </div>					  
										<div class="form-group">
										...
										<script type="text/javascript">
											jQuery(function($) {
												$('#orden').ace_spinner({value:<?php echo $modelo[5]; ?>,min:0,max:1000,step:1, touch_spinner: true, icon_up:'fa fa-caret-up bigger-110', icon_down:'fa fa-caret-down bigger-110'});
												//$("#orden").ace_spinner("destroy");
											});
										</script>										
