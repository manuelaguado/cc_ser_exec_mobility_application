	...
	<div data-page="index" class="page page-bg">
		<div class="page-content">
			<nav class="dashboard-menu">
				...
				<div class="row text-center">
					<div class="col-100" id="abandono_act_stime" style="display: none;">
						<a class="a14 menu-link" href="javascript:void(0)"  data-return="sitio_tiempo">
							<span>A14</span>
							<span class="label_code">Adandono de servicio</span>
						</a>
					</div>
					<div class="col-100" id="abandono_des_stime">
